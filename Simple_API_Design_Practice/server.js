...
const students = [
    { id: 1, name: "Aizen", age: 24, course: "Software Engineering" },
    { id: 2, name: "thinley", age: 22, course: "Computer Science" },
    { id: 3, name: "bob", age: 21, course: "Information Technology" },
    { id: 4, name: "Nidup", age: 20, course: "Water Engineering" },
    { id: 5, name: "Gunda", age: 19, course: "Civil Engineering" },
    { id: 6, name: "sosuke", age: 18, course: "Business Intelligence" }
];
